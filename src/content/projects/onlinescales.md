...
solution:
  [
    "ESP32 снимает показания с весов и датчиков",
    "Данные отправляются через VK Callback API",
    "Обработка происходит в Yandex Cloud Functions",
    "Результаты сохраняются в YDB",
  ]
date: "2026-01-01"
---
